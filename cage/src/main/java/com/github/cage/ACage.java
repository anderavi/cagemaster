 ...
 * @author akiraly
 */
public class ACage extends com.github.cage.Cage {
	/**
	 ...
	 * template.
	 */
	protected static final char[] TOKEN_DEFAULT_CHARACTER_SET = RandomCharacterGeneratorFactory.DEFAULT_DEFAULT_CHARACTER_SET;
